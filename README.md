...
A dark color theme for Cursor inspired by the easemate IDE. Features floating glass-like panels, rounded corners, smooth animations, and a deeply refined UI.
...
- ✅ Enable Custom UI Style and reload Cursor
...
- Unregister the extension from Cursor
