...
# One-liner: irm https://raw.githubusercontent.com/Berry7028/vscode-dark-islands/main/bootstrap.ps1 | iex
...
$RepoUrl = "https://github.com/Berry7028/vscode-dark-islands.git"
$Branch = "main"
